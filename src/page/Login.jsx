...
const Login = () => {
  ...
  //       // password: Yup.string().required('Không được để trống').matches(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/, 'Password must contain at least 8 characters, including letters and numbers'),
  //     }),
